...
import mockupImageSrc from "/static/images/app-mockup.png"
...
import appleIconImageSrc from "/static/images/apple-icon.png";
import googlePlayIconImageSrc from "/static/images/google-play-icon.png"
    ...
    <Container css={pushDownFooter && tw`mb-20 lg:mb-24`}>
      <Content>
        <Row>
          ...
          <ImageContainer>
            <img src={require(imageSrc)} alt="" tw="w-64"/>
          </ImageContainer>
        </Row>
